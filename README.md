...
In `init.lua`, uncomment the relevant line:
```lua
-- vim.g.codeium_manual = true   -- disable auto-trigger (manual mode only)
-- let g:codeium_manual = v:false -- enable auto-trigger
-- let g:codeium_manual = v:true  -- disable auto-trigger
```
